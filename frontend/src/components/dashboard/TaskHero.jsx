        ...
        <div className="flex gap-3 mt-6">
          ...
          {isInProgress && (
            <button
              ...
              className="flex-1 bg-emerald-500/20 border border-emerald-500/40 text-emerald-400 font-semibold rounded-xl py-2.5 text-sm transition-all duration-300 hover:bg-emerald-500/30"
            >
              ✓ Concluir
            </button>
          )}
